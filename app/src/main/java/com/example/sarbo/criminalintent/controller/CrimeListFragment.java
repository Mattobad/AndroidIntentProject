...
import com.example.sarbo.criminalintent.CrimePagerActivity;
...
public class CrimeListFragment extends Fragment {
    ...
    //convention for implementing menu from fragment
    ...
    // to respond to add menu button to add a new Crime
